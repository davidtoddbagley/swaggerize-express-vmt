                    ...
                    if (mediaTypes.indexOf(header) === -1) {
                        return res.status(415)
                            .send({
                                errors: [
                                    {
                                        detail: `Unsupported Content-Type header: '${header}' (valid media types: '${mediaTypes.join("', '")}')`,
                                        status: 415,
            ...
            if (mediaTypes.indexOf(header) === -1) {
                return res.status(406)
                    .send({
                        errors: [
                            {
                                detail: `Unsupported Accept header: '${header}' (valid media types: '${mediaTypes.join("', '")}')`,
                                status: 406,
